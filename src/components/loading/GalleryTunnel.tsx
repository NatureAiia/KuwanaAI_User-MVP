...
// Gallery Tunnel — three.js infinite tunnel of image/color slabs used as a
// full-bleed background behind the loading fun-facts screen. Ported from the
// Originkit "ImageBox" preset; the interactive label/cursor overlay is kept
// opt-in (defaults to off) because the loading screen has nothing to press.

import { useEffect, useMemo, useRef, type CSSProperties } from "react";
import * as THREE from "three";

// Default slab images — pulled from the same local asset store the rest of
// the app uses: Kuwana's mark, the Ai Institute Africa logo, and the provider
// logos kept under public/provider-logos/. TextureLoader loads same-origin
// files without CORS, and any missing file degrades to a blank slab.
const DEFAULT_IMAGES = [
  "/kuwana-mark.png",
  "/aiia-logo.jpg",
  "/provider-logos/econet.png",
  "/provider-logos/cbz-bank.png",
  "/provider-logos/fbc.png",
  "/provider-logos/posb-bank.png",
  "/provider-logos/psmas.png",
  "/provider-logos/zimnat.png",
  "/provider-logos/first-mutual.png",
  "/provider-logos/first-capital-bank.png",
];
...
const DEFAULTS = {
  ...
  lineColor: "#B0B0B0",
  lineOpacity: 50,
  colors: ["#2dd4bf", "#0d7568", "#38bdf8", "#ff7a5c", "#0369a1", "#ffb200"],
  grid: 4,
  speed: 100,
  boost: 100,
  fade: 100,
...
function srcOf(image: string | GalleryImage): string {
