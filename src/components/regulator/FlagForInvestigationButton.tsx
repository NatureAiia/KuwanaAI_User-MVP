...
// Regulator counterpart to corporate/FlagForInvestigationButton — same
// interaction, posts to the regulator-scoped route instead, which can open a
// case against any provider's listing rather than only the caller's own.
