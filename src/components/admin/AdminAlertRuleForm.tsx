...
type Metric = "total_providers" | "published_listings" | "pending_review_listings" | "open_investigations" | "pending_corporate_requests";
...
export function AdminAlertRuleForm() {
  ...
  return (
    <Card className="space-y-2.5">
      ...
      <p className="text-[12px] text-text-secondary">Watches a platform-wide metric and flags it here when the threshold is crossed.</p>
