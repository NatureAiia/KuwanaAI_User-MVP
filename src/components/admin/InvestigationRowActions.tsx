...
// Admin counterpart to regulator/InvestigationRowActions — identical fields
// (status, outcome, notes, evidence), posts to the admin-scoped route so
// these edits land in the admin audit log instead of going unrecorded.
