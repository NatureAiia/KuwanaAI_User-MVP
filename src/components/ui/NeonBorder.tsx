...
export default function NeonBorder(props: Props) {
    ...
    // Assigning ref.current outside an effect trips this repo's
    // react-hooks/refs rule; useLayoutEffect keeps it just as current for
    // the rAF loop below (runs before paint, every render) without doing
    // the mutation during render itself.
    useLayoutEffect(() => {
