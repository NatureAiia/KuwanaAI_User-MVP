...
// Desktop-only by nature: the sim reacts to mouse hover/move, so on touch
// devices it renders as a static glass button with no ripple. Reserve it
// for the one or two CTAs on a page that need to stand out, not every button.
"use client";
...
function OriginkitBaseWaterButton(props: WaterButtonProps) {
    ...
    return (
        <motion.div
            ...
            whileTap={press && !disabled ? { scale: 0.97 } : undefined}
